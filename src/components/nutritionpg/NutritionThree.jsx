    ...
    return (
        <div className="nutrition-section-three">
            ...
            <div className="nutrition-section-three-text">
                ...
                <p className="nutrition-section-three-second-para">Each week, I will provide you with meals and snacks options for each weekday, from Monday through Friday. For weekends, you can prepare other meals or enjoy your favorite choice of meal</p>
