    ...
    return (
        <div className="signup">
            ...
            <form>
                ...
                <input type="text" placeholder="First Name" className="first-name" required></input>
                <input type="text" placeholder="Last Name" className="last-name" required></input>
                ...
                <Link to="/login"><button type="submit" className="login-button">Already a Member? Log In</button></Link>
            </form>
        </div>
    )
}
